...
export function ClientSubTabs({ b2b, crm, entityClientIds, filteredMeetings, filteredReminders, filteredInteractions, selectedEntityId, addClientToEntity }: ClientSubTabsProps) {
  ...
  const tableProps = {
    ...
    customColumns: b2b.customColumns,
    getCustomValue: b2b.getCustomValue,
    onSetCustomValue: b2b.setCustomValue,
    onAddCustomColumn: b2b.addCustomColumn,
    onUpdateCustomColumn: b2b.updateCustomColumn,
    onDeleteCustomColumn: b2b.deleteCustomColumn,
